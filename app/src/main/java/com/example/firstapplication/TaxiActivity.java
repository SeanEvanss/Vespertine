...
public class TaxiActivity extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener,OnMapReadyCallback {
    ...
    //An alternative method would be to create and switch to a separate thread but it's more tedious and needs thread management control.
    ...
    public class RetrieveFeedTask extends AsyncTask<String,Void, List<LatLng>>{
        ...
        //doInBackground is a predefied function that allows processes to be run in the background(networking, general processes)
